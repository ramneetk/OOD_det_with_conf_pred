...
class Regressor(nn.Module):
    def __init__(self, resnet_type=18, indim=1024, num_classes=8,dropout = None): #indim = [orig_img_features,transformed_img_features], num_classes is the number of possible transformations
    ...
    def forward(self, x1, x2, out_feat_keys=None):
        x1 = self.resnet(self.dropout_layer(x1), out_feat_keys)
        x2 = self.resnet(self.dropout_layer(x2), out_feat_keys)
